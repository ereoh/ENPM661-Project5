...
: ${AMENT_CURRENT_PREFIX:="/workspace/install/turtlebot3_project3"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/turtlebot3_project3/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/turtlebot3_project3/environment/path.sh"

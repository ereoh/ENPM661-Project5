...
: ${AMENT_CURRENT_PREFIX:="/workspace/install/gazebo_worlds"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/gazebo_worlds/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/gazebo_worlds/environment/path.sh"
